...
//             setCookie("fcm_id",data.registrationId,365);
//  var location_id = getCookielocation("loc_id");
...
// storing the cookies value
function setCookie(cname, cvalue, exdays) {
       // showsnackbar("setCookie " + cvalue);
    var d = new Date();
    d.setTime(d.getTime() + (exdays*24*60*60*1000));
    var expires = "expires="+ d.toUTCString();
    document.cookie = cname + "=" + cvalue + ";" + expires + ";path=/";
}
// for get cookies value
